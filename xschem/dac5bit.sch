...
N 830 -150 830 -80 { lab=AGND}
N 930 -170 1000 -170 { lab=CompOut}
N -770 -360 -770 -340 { lab=Vin}
N -580 -360 -580 -340 { lab=AGND}
N -1040 -540 -1040 -510 { lab=SH}
N -1040 -540 -970 -540 { lab=SH}
N 1000 -170 1040 -170 { lab=CompOut}
N 1010 -170 1010 -130 { lab=CompOut}
...
N -530 -110 -440 -110 { lab=VREF}
N -530 70 -430 70 { lab=VREF}
N -530 240 -430 240 { lab=VREF}
...
N -530 460 -440 460 { lab=VREF}
N -650 420 -440 420 { lab=Vin}
N -720 440 -440 440 { lab=AGND}
N -530 570 -430 570 { lab=VREF}
...
N -130 860 640 860 {
lab=c6v}
N 520 670 520 700 { lab=c5v}
N 490 700 520 700 { lab=c5v}
N 640 860 640 890 { lab=c6v}
N 610 890 640 890 { lab=c6v}
N -530 670 -430 670 {
lab=VREF}
N -650 690 -430 690 {
lab=Vin}
...
N -720 720 -720 950 {
lab=AGND}
N -230 -690 -230 -660 { lab=B3}
N -230 -690 -160 -690 { lab=B3}
N -540 -820 -540 -790 { lab=B4}
N -540 -820 -470 -820 { lab=B4}
...
C {symbols/lab_wire.sym} 830 -80 0 0 {name=l6 sig_type=std_logic lab=AGND}
...
C {symbols/cap_mim_m3_1.sym} 1010 -100 0 0 {name=C5 model=cap_mim_m3_1 W=10 L=10 MF=1 spiceprefix=X}
C {symbols/gnd.sym} 1010 -70 0 0 {name=l29 lab=GND}
C {symbols/lab_wire.sym} 1040 -170 0 0 {name=l30 sig_type=std_logic lab=CompOut}
...
C {skywater_comparator.sym} 810 -220 2 1 {name=x3}
...
C {4x1analogmux.sym} -280 720 0 0 {name=x7}
C {symbols/ipin.sym} -920 -150 1 0 {name=p1 lab=B3}
C {symbols/ipin.sym} -860 -150 1 0 {name=p12 lab=B4}
C {4x1analogmux.sym} -280 910 0 0 {name=x8}
C {symbols/cap_mim_m3_1.sym} 520 -160 0 0 {name=C4 model=cap_mim_m3_1 W=10 L=10 MF=8 spiceprefix=X}
C {symbols/cap_mim_m3_1.sym} 640 -160 0 0 {name=C8 model=cap_mim_m3_1 W=10 L=10 MF=16 spiceprefix=X}
C {symbols/lab_wire.sym} 490 700 0 0 {name=l1 sig_type=std_logic lab=c5v}
C {symbols/lab_wire.sym} 610 890 0 0 {name=l2 sig_type=std_logic lab=c6v}
C {symbols/vsource.sym} -230 -630 0 0 {name=V2 value="DC 0 pwl (0n 0 \{t0\} 0 \{t0r\} 2 \{t1\} 2 \{t1r\} 0 \{t2\} 0 \{t2r\} 2 \{t3\} 2 \{t3r\} \{b2d\})"}
C {symbols/gnd.sym} -230 -600 0 0 {name=l5 lab=GND}
C {symbols/lab_pin.sym} -160 -690 0 1 {name=x9 sig_type=std_logic lab=B3}
C {symbols/vsource.sym} -540 -760 0 0 {name=V6 value="DC 0 pwl (0n 0 \{t0\} 0 \{t0r\} 2 \{t1\} 2 \{t1r\} 0 \{t2\} 0 \{t2r\} 2 \{t3\} 2 \{t3r\} \{b2d\})"}
C {symbols/gnd.sym} -540 -730 0 0 {name=l7 lab=GND}
C {symbols/lab_pin.sym} -470 -820 0 1 {name=x10 sig_type=std_logic lab=B4}
